...
# Attach least-privilege policy for Argo CD
resource "aws_iam_policy" "argocd_policy" {
  name   = "argocd-irsa-policy"
  policy = file("${path.module}/policies/argocd-policy.json")
}
...
resource "aws_iam_policy" "prometheus_policy" {
  name   = "prometheus-irsa-policy"
  policy = file("${path.module}/policies/prometheus-policy.json")
}
